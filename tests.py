...
class TestBooksCollector:
    ...
    def test_add_new_book_with_len_0_and_43_book_not_added(self,collector, book_name):
    ...
    def test_set_book_genre_where_genre_in_genre_list(self, collector):
        collector.add_new_book('Преступление и наказание')
    ...
    def test_get_book_genre_added_genre_from_list(self,collector, name, genre):
    ...
    def test_get_books_genre_with_data_in_dict(self,collector, name, genre):
        expected = {name: genre}
        collector.add_new_book(name)
        collector.set_book_genre(name, genre)
        assert collector.get_books_genre() == expected

    def test_get_books_for_children_genre_for_child(self, collector):
    ...
    def test_get_books_for_children_genre_not_for_child(self, collector):
        collector.add_new_book('Преступление и наказание')
        collector.set_book_genre('Преступление и наказание','Детективы')
        assert 'Преступление и наказание' not in collector.get_books_for_children()

    def test_add_book_in_favorites_book_isnt_in_favorites(self, collector):
    ...
    def test_delete_book_from_favorites_add_two_books_one_delete(self, collector):
        collector.add_new_book('Мобильник')
        collector.add_new_book('Кот в сапогах')
